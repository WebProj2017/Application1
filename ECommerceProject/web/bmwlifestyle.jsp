...
<div class="container">
    ...
    $('.example1').wmuSlider();
        ...
        <!---->
        <h1><font size="40" color="RED"><b>HÀNG HÓA CHƯA ĐƯỢC THÔNG QUAN, MONG QUÝ KHÁCH THÔNG CẢM, TRONG KHO CÒN MẤY BÌNH NƯỚC</font></b></h1>
        <!---->
        <div class="products">
            <%=map.get("products")%>
        </div>
        ...
        <div class="foo-grids">
            ...
            <div class="col-md-3 footer-grid">
                ...
                <ul class="location">
                    ...
                    <li><a href="error.jsp">thanhgay69@gmail.com
                    <div class="clearfix"></div>
                </ul>						
            </div>
            <div class="clearfix"></div>
