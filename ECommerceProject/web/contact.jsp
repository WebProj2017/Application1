...
<!---->
<div class="container">
    <h3><b>Form yêu cầu tư vấn - liên lạc với E-commerce</b> </h3>
    <form>
        ...
        <b>Bạn có đang quan tâm đến sản phẩm nào đang được bán của E-commerce ?</b> <br>
        ...
        <input type="radio" name="use" value="none">  Không có, tôi cần hỏi về dịch vụ. <br> 
        <b>Bạn cần chúng tôi tư vấn cho bạn về điều gì?</b> <br>
        <select name="sub">
            <option value="gen">Tổng quát về E-commerce</option>
            <option value="phone">Tôi cần biết thêm về sản phẩm tôi đang quan tâm</option>
            <option value="lap">Tôi muốn biết thêm về các dịch vụ của E-commerce</option>
            <option value="tab">Tôi cần yêu cầu kỹ thuật viên tư vấn sử dụng sản phẩm/dịch vụ</option>
            <option value="tv">Tôi cần tư vấn bảo hành sản phẩm</option>
        </select> <br>
        <textarea name="feed" rows="7" cols="70">Bạn vui lòng cho biết thêm thông tin về sản phẩm bạn đã mua và các yêu cầu của bạn tại đây</textarea>
